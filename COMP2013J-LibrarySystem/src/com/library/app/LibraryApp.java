...
public class LibraryApp {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,
                        "Failed to connect to MySQL:\n" + ex.getMessage()
                                ...
                                + "3. Edit config/db.properties (password)\n"
                                + "4. Put mysql-connector-j-*.jar in lib/\n\nSee README.md",
                        "Startup Error", JOptionPane.ERROR_MESSAGE);
                System.exit(1);
            }
            new LoginFrame(staff -> new MainFrame(staff).setVisible(true)).setVisible(true);
        });
    }
    ...
    static Path resolveProjectRoot() {
        ...
        try {
            Path fromClass = Paths.get(LibraryApp.class.getProtectionDomain()
