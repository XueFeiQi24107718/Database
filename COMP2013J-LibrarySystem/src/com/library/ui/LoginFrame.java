...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame(Consumer<Staff> onSuccess) {
    ...
    private void buildUi() {
        ...
        JLabel hint = new JLabel("<html>Demo: <b>admin</b> / <b>admin</b> or <b>librarian</b> / <b>book</b></html>");
    ...
    private void attemptLogin() {
        ...
        try {
            ...
            var staff = dao.authenticate(user, pass);
            if (staff.isPresent()) {
                dispose();
                onSuccess.accept(staff.get());
            } else {
